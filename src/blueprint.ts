 ...
 */
export function isDynamicBlueprint(module: BlueprintModule): module is { default: (config: MergedConfiguration) => BlueprintAction[] } {
 ...
 */
export function isLegacyBlueprint(module: BlueprintModule): module is { blueprint: LegacyBlueprint } {
  return typeof (module as any).blueprint === 'object' && Array.isArray((module as any).blueprint.actions);
}
