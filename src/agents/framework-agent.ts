...
export class FrameworkAgent extends AbstractAgent {
  ...
  protected async executeInternal(context: AgentContext): Promise<AgentResult> {
    ...
    try {
      ...
      return this.createErrorResult(
        ...
        `Framework setup failed: ${errorMessage}`,
        [],
        startTime,
        error
      );
  ...
  private determineFrameworkType(context: AgentContext, pluginSelection: any): string {
  ...
  private async executeFrameworkPlugin(frameworkType: string, context: AgentContext): Promise<any> {
