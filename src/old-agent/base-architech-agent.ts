...
export class BaseArchitechAgent extends AbstractAgent {
  ...
  protected async executeInternal(context: AgentContext): Promise<AgentResult> {
    ...
    try {
      ...
      context.logger.error(`Failed to create monorepo structure: ${errorMessage}`, error as Error);
      
      return this.createErrorResult(
        'MONOREPO_CREATION_FAILED',
  ...
  private async createRootPackageJson(projectPath: string, context: AgentContext): Promise<void> {
    await templateService.renderAndWrite(
      'base-architech',
      'package.json.ejs',
  ...
  private async createTurboConfig(projectPath: string, context: AgentContext): Promise<void> {
    await templateService.renderAndWrite(
      'base-architech',
      'turbo.json.ejs',
  ...
  private async createNextJSApp(projectPath: string, context: AgentContext): Promise<void> {
  ...
  private async updateWebAppPackageJson(appPath: string, context: AgentContext): Promise<void> {
  ...
  private async createWebAppESLintConfig(appPath: string): Promise<void> {
    const eslintConfig = {
  ...
  private async createPackageDirectories(projectPath: string): Promise<void> {
...
`;
  ...
  private getPackageDependencies(pkg: string, projectName: string): Record<string, string> {
  ...
  private async createPackageTypeScriptConfig(packagePath: string, pkg: string): Promise<void> {
    const tsConfig = {
  ...
  private async createRootConfigFiles(projectPath: string, context: AgentContext): Promise<void> {
  ...
  private async initializeGit(projectPath: string, context: AgentContext): Promise<void> {
    try {
...
`;
  ...
  private async createReadme(projectPath: string, context: AgentContext): Promise<void> {
...
`;
  ...
  async rollback(context: AgentContext): Promise<void> {
    ...
    try {
      ...
      context.logger.error('Failed to rollback BaseArchitechAgent', error as Error);
    }
  }
}