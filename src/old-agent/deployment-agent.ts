...
export class DeploymentAgent extends AbstractAgent {
  ...
  private async createDockerfile(context: AgentContext): Promise<Artifact[]> {
...
`;
  ...
  private async createGitHubActions(context: AgentContext): Promise<Artifact[]> {
...
`;
  ...
  private async createEnvironmentFiles(context: AgentContext): Promise<Artifact[]> {
