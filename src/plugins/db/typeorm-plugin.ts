...
export class TypeORMPlugin implements IPlugin {
  ...
  private async createTypeORMConfig(context: PluginContext): Promise<void> {
    const { projectPath } = context;
  ...
  private async createDatabaseStructure(context: PluginContext): Promise<void> {
    const { projectPath } = context;
  ...
  private async createBaseEntity(entitiesPath: string): Promise<void> {
...
`;
  ...
  private async createUserEntity(entitiesPath: string): Promise<void> {
...
`;
  ...
  private async createUserRepository(repositoriesPath: string): Promise<void> {
...
`;
  ...
  private async createDatabaseConnection(dbPath: string): Promise<void> {
...
`;
  ...
  private async createInitialMigration(migrationsPath: string): Promise<void> {
...
`;
  ...
  private getTypeORMConfigContent(): string {
