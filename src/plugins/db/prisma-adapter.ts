 ...
 */
export class PrismaAdapter implements UnifiedDatabase {
  private prismaClient: any;
  private prismaSchema: any;
  private prismaConfig: any;
  ...
  // Helper methods
  private getPrismaModel(tableName: string): string | null {
    if (!this.prismaSchema) return null;
  ...
  private buildPrismaWhere(where: any): any {
  ...
  private extractColumns(tableName: string): ColumnSchema[] {
    ...
    if (tableName === 'users') {
      columns.push(
        ...
        { name: 'name', type: 'String', nullable: true, primaryKey: false, unique: false },
        { name: 'createdAt', type: 'DateTime', nullable: false, primaryKey: false, unique: false },
        { name: 'updatedAt', type: 'DateTime', nullable: false, primaryKey: false, unique: false }
      );
    }
  ...
  private extractIndexes(tableName: string): IndexSchema[] {
  ...
  private extractRelations(tableName: string): RelationSchema[] {
