...
import { UI_LIBRARIES, UILibrary, ComponentOption, ThemeOption } from '../../../../types/core.js';
...
export class MuiSchema {
  static getParameterSchema(): ParameterSchema {
    return {
      ...
      groups: [
        ...
        { id: 'features', name: 'Additional Features', description: 'Enable additional MUI features.', order: 3, parameters: ['enableAnimations', 'enableRTL'] },
      ],
      parameters: [
        {
          id: 'theme',
        ...
        },
        {
          ...
          type: 'boolean',
          description: 'Enable MUI animations and transitions.',
          required: true,
          default: true,
          group: 'features'
        },
  ...
  static getUILibraries(): UILibrary[] {
    return [UI_LIBRARIES.MATERIAL_UI];
  }
