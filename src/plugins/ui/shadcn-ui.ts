...
import { IPlugin, PluginContext, PluginResult, PluginMetadata, PluginCategory, ValidationResult, CompatibilityMatrix, ConfigSchema, PluginRequirement, TargetPlatform } from '../../types/plugin.js';
...
export class ShadcnUIPlugin implements IPlugin {
  ...
  private async updatePackageJson(uiPackagePath: string, context: PluginContext): Promise<void> {
    const packageJson = {
  ...
  private async createTailwindConfig(uiPackagePath: string, context: PluginContext): Promise<void> {
  ...
  private async createUtilities(uiPackagePath: string, context: PluginContext): Promise<void> {
...
export function cn(...inputs: ClassValue[]) {
  ...
  private async createComponentStructure(uiPackagePath: string, context: PluginContext): Promise<void> {
    const directories = [
      'components',
      'components/ui',
      'styles',
  ...
  private async createCSSFiles(uiPackagePath: string, context: PluginContext): Promise<void> {
...
@layer base {
  * {
  ...
  private async installShadcnComponents(uiPackagePath: string, context: PluginContext, pluginConfig: any): Promise<void> {
  ...
  private async createComponentsJson(projectRoot: string, context: PluginContext): Promise<void> {
  ...
  private async createComponentManually(uiPackagePath: string, componentName: string, context: PluginContext): Promise<void> {
...
export { ${componentName.charAt(0).toUpperCase() + componentName.slice(1)} }`;
  ...
  private async createPlaceholderComponent(uiPackagePath: string, componentName: string, context: PluginContext): Promise<void> {
    const componentPath = path.join(uiPackagePath, 'components', 'ui', `${componentName}.tsx`);
...
export { ${componentName.charAt(0).toUpperCase() + componentName.slice(1)} }`;
  ...
  private async createIndex(uiPackagePath: string, context: PluginContext): Promise<void> {
