...
export class ShadcnUIPlugin implements IPlugin {
  ...
  async uninstall(context: PluginContext): Promise<PluginResult> {
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Unknown error';
      return this.createErrorResult(
        `Failed to uninstall Shadcn/ui: ${errorMessage}`,
        startTime,
        [],
        error
      );
  ...
  private async createTailwindConfig(context: PluginContext): Promise<void> {
    const { projectPath } = context;
...
export function cn(...inputs: ClassValue[]) {
  ...
  private async createButtonComponent(componentsPath: string, utilsPath: string): Promise<void> {
...
export { Button, buttonVariants }`;
  ...
  private async createCardComponent(componentsPath: string, utilsPath: string): Promise<void> {
...
export { Card, CardHeader, CardFooter, CardTitle, CardDescription, CardContent }`;
  ...
  private async createInputComponent(componentsPath: string, utilsPath: string): Promise<void> {
...
export { Input }`;
  ...
  private async createLabelComponent(componentsPath: string, utilsPath: string): Promise<void> {
...
export { Label }`;
  ...
  private async createFormComponent(componentsPath: string, utilsPath: string): Promise<void> {
...
export {
  ...
  private async createDialogComponent(componentsPath: string, utilsPath: string): Promise<void> {
...
`;
  ...
  private async initializeShadcn(context: PluginContext): Promise<void> {
    const { projectPath, pluginConfig } = context;
  ...
  private async createFrameworkDetectionFiles(context: PluginContext): Promise<void> {
    const { projectPath } = context;
...
module.exports = nextConfig;`;
  ...
  private async createComponentsConfig(context: PluginContext): Promise<void> {
    const { projectPath } = context;
...
@layer base {
  * {
  ...
  private async setupTailwindCSS(context: PluginContext): Promise<void> {
    const { projectPath } = context;
...
module.exports = {
  ...
  private async addComponents(context: PluginContext): Promise<void> {
    const { projectPath, pluginConfig } = context;
  ...
  private async customizeConfiguration(context: PluginContext): Promise<void> {
    const { projectPath, pluginConfig } = context;
