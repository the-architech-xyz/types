...
interface TamaguiConfig {
  ...
  tokens: boolean;
  fonts: string[];
  icons: 'tamagui' | 'lucide' | 'heroicons';
...
export class TamaguiPlugin implements IPlugin {
  ...
  async install(context: PluginContext): Promise<PluginResult> {
    ...
    const tamaguiConfig = pluginConfig as TamaguiConfig;
    ...
    try {
      ...
      return this.createErrorResult(
        `Failed to install Tamagui: ${error instanceof Error ? error.message : 'Unknown error occurred'}`,
        startTime,
        [],
        error
      );
  ...
  async uninstall(context: PluginContext): Promise<PluginResult> {
    ...
    try {
      ...
      return this.createErrorResult(
        `Failed to uninstall Tamagui: ${error instanceof Error ? error.message : 'Unknown error occurred'}`,
        startTime,
        [],
        error
      );
  ...
  async update(context: PluginContext): Promise<PluginResult> {
    ...
    try {
      ...
      return this.createErrorResult(
        `Failed to update Tamagui: ${error instanceof Error ? error.message : 'Unknown error occurred'}`,
        startTime,
        [],
        error
      );
  ...
  private async installDependencies(context: PluginContext, config: TamaguiConfig): Promise<void> {
    const { projectPath } = context;
  ...
  private async initializeTamagui(projectPath: string, config: TamaguiConfig, context: PluginContext): Promise<void> {
    try {
  ...
  private async installAdditionalDependencies(projectPath: string, config: TamaguiConfig, context: PluginContext): Promise<void> {
  ...
  private async createConfigurationFiles(projectPath: string, config: TamaguiConfig): Promise<void> {
    ...
    await fsExtra.writeFile(
      path.join(srcDir, 'tamagui.css'),
      cssContent
    );
  }

  private async createExampleComponents(projectPath: string, config: TamaguiConfig): Promise<void> {
  ...
  private generateTamaguiConfig(config: TamaguiConfig): string {
    if (config.platform === 'web' || config.platform === 'both') {
  ...
  private generateWebTamaguiConfig(config: TamaguiConfig): string {
...
`;
  ...
  private generateReactNativeTamaguiConfig(config: TamaguiConfig): string {
    return `import { createTamagui, createTokens } from 'tamagui'
...
`;
  ...
  private generateTamaguiCSS(): string {
...
`;
  ...
  private generateButtonComponent(config: TamaguiConfig): string {
    if (config.platform === 'web' || config.platform === 'both') {
  ...
  private generateWebButtonComponent(): string {
...
`;
  ...
  private generateReactNativeButtonComponent(): string {
    return `import React from 'react';
...
`;
  ...
  private generateCardComponent(config: TamaguiConfig): string {
    if (config.platform === 'web' || config.platform === 'both') {
  ...
  private generateWebCardComponent(): string {
    return `import React from 'react';
...
`;
  ...
  private generateReactNativeCardComponent(): string {
    return `import React from 'react';
...
`;
  ...
  private generateInputComponent(config: TamaguiConfig): string {
    if (config.platform === 'web' || config.platform === 'both') {
  ...
  private generateWebInputComponent(): string {
    return `import React from 'react';
...
`;
  ...
  private generateReactNativeInputComponent(): string {
    return `import React from 'react';
