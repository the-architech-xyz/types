...
export class BetterAuthPlugin {
    ...
    // ============================================================================
    async setupAuthentication(context) {
    ...
    async updateEnvConfig(projectPath, authConfig, context) {
        ...
        await this.templateService.renderAndWrite('auth', '.env.local.ejs', envPath, envVars, { logger: context.logger });
    }
}
