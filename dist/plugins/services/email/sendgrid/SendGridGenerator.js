export class SendGridGenerator {
    static generateEmailClient(config) {
...
`;
    ...
    static generateEmailConfig(config) {
        return `
...
`;
    ...
    static generateEmailService(config) {
...
//# sourceMappingURL=SendGridGenerator.js.map