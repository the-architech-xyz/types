export class PayPalGenerator {
    static generatePayPalClient(config) {
...
`;
    ...
    static generateCreateOrderRoute(config) {
...
`;
    ...
    static generateCaptureOrderRoute(config) {
        return `import { NextRequest, NextResponse } from 'next/server';
import client from '@/lib/paypal/client';
import checkoutNodeJssdk from '@paypal/checkout-server-sdk';
...
`;
    ...
    static generateWebhookRoute(config) {
        return `import { NextRequest, NextResponse } from 'next/server';
import client from '@/lib/paypal/client';
...
//# sourceMappingURL=PayPalGenerator.js.map