...
export class EthereumPlugin {
    ...
    async install(context) {
        ...
        try {
            ...
            this.logger.error('Failed to install Ethereum plugin:', error);
            return {
                success: false,
                artifacts: [],
                dependencies: [],
