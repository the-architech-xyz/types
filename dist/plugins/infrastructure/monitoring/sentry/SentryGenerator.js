export class SentryGenerator {
    static generateSentryClientConfig(config) {
...
`;
    ...
    static generateSentryServerConfig(config) {
...
`;
    ...
    static generateNextConfig(config) {
...
//# sourceMappingURL=SentryGenerator.js.map