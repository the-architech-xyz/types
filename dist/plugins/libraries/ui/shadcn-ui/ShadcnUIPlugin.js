...
export class ShadcnUIPlugin extends BaseUIPlugin {
    ...
    async install(context) {
        ...
        try {
            ...
            // 3. Add dependencies
            await this.installDependencies(['tailwind-merge', 'class-variance-authority', 'clsx', 'lucide-react', 'tailwindcss-animate'], ['tailwindcss', 'postcss', 'autoprefixer']);
            // 4. Add scripts (e.g., shadcn-ui cli)
            await this.addScripts({
                "ui:add": "pnpm dlx shadcn-ui@latest add"
            });
            // 5. Setup Theme Provider
            await this.setupThemeProvider(context, 'import { ThemeProvider } from "@/components/theme-provider"', 'ThemeProvider', 'attribute="class" defaultTheme="system" enableSystem');
