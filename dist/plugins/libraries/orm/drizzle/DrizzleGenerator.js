...
export class DrizzleGenerator {
     ...
     */
    async generateDrizzleConfig(config) {
     ...
     */
    async generateSchemaFile(config) {
     ...
     */
    async generateConnectionFile(config) {
     ...
     */
    async generateUnifiedInterface(config) {
     ...
     */
    async generateInitialMigration(config) {
