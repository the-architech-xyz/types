...
export class MongooseGenerator {
    static generateMongooseConnection(config) {
...
`;
    ...
    static generateUserModel(config) {
...
`;
    ...
    static generateTimestampPlugin() {
        return `/**
...
`;
    ...
    static generateSoftDeletePlugin() {
        return `/**
