...
import { PrismaConfigSchema, PrismaDefaultConfig } from './PrismaSchema.js';
...
export class PrismaPlugin {
        ...
        try {
            ...
            return {
                ...
                configs: [
                    {
                        file: '.env',
                        content: PrismaGenerator.generateEnvConfig(pluginConfig),
    ...
    async initializePrismaConfig(context) {
        ...
        const schemaContent = PrismaGenerator.generatePrismaSchema(pluginConfig);
