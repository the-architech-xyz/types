...
export class PrismaPlugin {
    ...
    async install(context) {
        ...
        const prismaConfig = pluginConfig;
        try {
            ...
            return this.createErrorResult(`Failed to install Prisma: ${error instanceof Error ? error.message : 'Unknown error occurred'}`, startTime, [], error);
        }
    }
    async uninstall(context) {
        ...
        try {
            ...
            return this.createErrorResult(`Failed to uninstall Prisma: ${error instanceof Error ? error.message : 'Unknown error occurred'}`, startTime, [], error);
        }
    }
    async update(context) {
        ...
        try {
            ...
            return this.createErrorResult(`Failed to update Prisma: ${error instanceof Error ? error.message : 'Unknown error occurred'}`, startTime, [], error);
        }
    }
    // ============================================================================
    ...
    async initializePrisma(projectPath, config, context) {
        try {
...
`;
    ...
    async createPrismaSchema(projectPath, config) {
    ...
    async generatePrismaClientCLI(projectPath) {
        try {
            await this.runner.execCommand(['npx', 'prisma', 'generate'], {
                cwd: projectPath
            });
    ...
    async createDatabaseUtilities(projectPath) {
    ...
    async createSeedScript(projectPath) {
