...
export class PluginRegistryImpl {
    ...
    getByCategory(category) {
        return this.getAll().filter(plugin => plugin.getMetadata().category === category);
    }
    // ============================================================================
    // COMPATIBILITY CHECKING
    // ============================================================================
    getCompatible(projectType, platforms) {
        return this.getAll().filter(plugin => {
            ...
            const hasPlatformMatch = platforms.some(platform => compatibility.platforms.includes(platform));
            if (!hasPlatformMatch) {
                return false;
            }
            return true;
    ...
    getPluginsByTag(tag) {
        return this.getAll().filter(plugin => plugin.getMetadata().tags.includes(tag));
    }
    // ============================================================================
    // STATISTICS
    // ============================================================================
