...
export class WorkflowTemplateService {
     ...
     */
    static getTemplatesByComplexity(complexity) {
        return WORKFLOW_TEMPLATES.filter(template => template.complexity === complexity);
    }
    /**
     * Get templates by target audience
     */
    static getTemplatesByAudience(audience) {
        return WORKFLOW_TEMPLATES.filter(template => template.targetAudience.includes(audience));
    }
    /**
