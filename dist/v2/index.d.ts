 ...
 */
export type DependencyCapability = 'auth' | 'database' | 'ui' | 'email' | 'storage' | 'data-fetching' | 'state' | 'api' | 'jobs' | 'monitoring' | 'payment';
/**
 ...
 */
export declare function isV2Genome(genome: any): genome is V2Genome;
/**
 * Define a V2 genome with type safety
 */
export declare function defineV2Genome(genome: V2Genome): V2Genome;
