...
export async function scaleToMonorepoCommand(options = {}) {
...
async function analyzeCurrentProject(options) {
...
async function confirmScaling(config) {
...
async function restructureProject(config) {
...
async function createUIPackage(config, srcPath, packagesPath) {
...
async function createDBPackage(config, srcPath, packagesPath) {
...
async function createAuthPackage(config, srcPath, packagesPath) {
...
async function createConfigPackage(config, packagesPath) {
...
function displayScalingSummary(config) {
...
//# sourceMappingURL=scale-to-monorepo.js.map