...
export class DeploymentAgent extends AbstractAgent {
    ...
    async executeInternal(context) {
        ...
        try {
            ...
            return this.createErrorResult('DEPLOYMENT_SETUP_FAILED', `Failed to setup deployment: ${errorMessage}`, [], startTime, error);
        }
    }
    // ============================================================================
    // UNIFIED INTERFACE EXECUTION
    // ============================================================================
    async executeDeploymentPluginUnified(context, pluginName, deploymentConfig) {
        try {
    ...
    async validateDeploymentSetupUnified(context, pluginName) {
        try {
    ...
    // PLUGIN SELECTION
    // ============================================================================
    async selectDeploymentPlugin(context, deploymentConfig) {
    ...
    getPluginConfig(deploymentConfig, pluginName) {
        const config = {
            platform: deploymentConfig.platform,
            environment: deploymentConfig.environment,
            features: deploymentConfig.features,
    ...
    async rollback(context) {
        ...
        try {
            ...
            context.logger.error('Deployment rollback failed', error);
        }
    }
}
