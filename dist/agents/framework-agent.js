...
export class FrameworkAgent extends AbstractAgent {
    ...
    async validate(context) {
        ...
        // Validate framework
        const framework = context.projectStructure?.template || context.config.template;
    ...
    async executeInternal(context) {
        ...
        const framework = projectStructure?.template || context.config.template;
        const structure = projectStructure?.type || context.config.structure;
        ...
        try {
            ...
            return this.createErrorResult('FRAMEWORK_INSTALLATION_FAILED', `Failed to install framework: ${errorMessage}`, [], this.startTime, error);
        }
    }
    // ============================================================================
    // PRIVATE METHODS - Framework Installation
    // ============================================================================
    getInstallPath(context, structure) {
        if (structure === 'monorepo') {
            return path.join(context.projectPath, 'apps', 'web');
        }
        return context.projectPath;
    }
    async executeFrameworkPlugin(context, framework, installPath) {
    ...
    getPluginConfig(context, framework, installPath) {
        return {
