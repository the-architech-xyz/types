...
export class BestPracticesAgent extends AbstractAgent {
    ...
    async executeInternal(context) {
        ...
        try {
            ...
            context.logger.error(`Failed to configure code quality tools: ${errorMessage}`, error);
            return this.createErrorResult('CODE_QUALITY_SETUP_FAILED', `Failed to configure code quality tools: ${errorMessage}`, [], 0, error);
        }
    }
    // ============================================================================
    // VALIDATION
    ...
    async configurePrettier(context) {
...
`;
    ...
    async configureTypeScript(context) {
...
//# sourceMappingURL=best-practices-agent.js.map