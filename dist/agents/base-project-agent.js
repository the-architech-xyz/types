...
export class BaseProjectAgent extends AbstractAgent {
    ...
    async createProjectStructure(context) {
        ...
        const isMonorepo = context.config.projectType === 'scalable-monorepo';
    ...
    async createMonorepoStructure(context) {
        ...
        context.logger.info('Monorepo structure created');
    }
    async createSingleAppStructure(context) {
        const { projectPath } = context;
        // Create single app directories
        const directories = [
            'src',
            'src/app',
            'src/components',
        ...
        context.logger.info('Single app structure created');
    }
    // ============================================================================
...
${isMonorepo ? this.getMonorepoReadme() : this.getSingleAppReadme()}
...
${isMonorepo ? this.getMonorepoStructure() : this.getSingleAppStructure()}

## Available Scripts

${isMonorepo ? this.getMonorepoScripts() : this.getSingleAppScripts()}
